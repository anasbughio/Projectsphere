...
import { 
  ...
  ArrowUpRight, AlertTriangle, Loader2, FolderKanban, Mail, CheckCircle
} from 'lucide-react';
import { 
  PieChart, Pie, Cell, 
...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col gap-6 font-sans pb-8 px-4 sm:px-6 lg:px-8 max-w-full overflow-hidden">
      ...
      {/* Toast Notification missing in original code */}
      {reportStatus && (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        <div className="bg-[#1a1c26] p-5 rounded-xl border border-white/5 shadow-sm">
          ...
          <div className="text-2xl sm:text-3xl font-bold text-white mb-1">$1.2M</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        <div className="lg:col-span-2 flex flex-col gap-4 sm:gap-6">
          ...
          {/* PROJECT PORTFOLIO BLOCK (Made fully scrollable horizontally) */}
        ...
        <div className="flex flex-col gap-4 sm:gap-6">
          ...
          <div className="bg-[#1a1c26] rounded-xl border border-white/5 shadow-sm p-4 sm:p-6 relative overflow-hidden">
            <h2 className="text-base sm:text-lg font-bold text-white mb-1 relative z-10">System Health</h2>
            <p className="text-[10px] sm:text-xs text-[#84889c] mb-4 sm:mb-6 relative z-10">Real-time node performance monitor</p>
            <div className="flex items-end justify-between relative z-10">
              <div>
                <div className="text-3xl sm:text-4xl font-bold text-white tracking-tight">99.9%</div>
                <div className="text-[9px] sm:text-[10px] font-semibold text-[#7c7fff] uppercase tracking-widest mt-1">Uptime maintained</div>
              </div>
            </div>
          </div>
