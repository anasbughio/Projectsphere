...
const Dashboard = () => {
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      // Backend ki nayi API ko call kar rahe hain
    ...
    {/* 1. TOP KPI CARDS BLOCK */}
      <div className="flex items-center justify-end w-full my-4">
        <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-[#7c7fff] to-[#5a5fe0] hover:opacity-90 disabled:opacity-50 text-white text-sm font-medium rounded-lg transition-all duration-200 shadow-sm shadow-[#7c7fff]/20"
          >
